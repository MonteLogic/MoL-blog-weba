      ...
      {isAdmin && (
        <div className="flex items-center gap-4 rounded-lg p-4 mb-8 border border-slate-200 dark:border-slate-700" style={{ backgroundColor: 'var(--bg-secondary)' }}>
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-md border border-indigo-600 bg-indigo-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-indigo-700"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-md border border-gray-600 bg-transparent px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800"
          >
            <svg
              className="h-4 w-4"
              fill="currentColor"
